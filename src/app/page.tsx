    ...
    <main id="main-content" className="min-h-screen antialiased">
      <div className="mx-auto mt-10 max-w-5xl px-8 md:mt-20">
        ...
        <p className="mt-8 max-w-2xl text-sm leading-loose tracking-wide text-gray-300 md:text-base">
          I&apos;m Michal Dohnal, a passionate Frontend Developer with extensive
          experience in building dynamic, user-centric web applications. Skilled
          in React, Next.js, TypeScript, and Tailwind CSS, I have a proven track
          record of delivering high-quality, interactive solutions. From
          optimizing insurance application forms to crafting map-editing tools.
        </p>
      </div>
      <div className="mx-auto mt-10 max-w-5xl px-8 md:mt-20">
